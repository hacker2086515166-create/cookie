...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <h1>Ayush 🍒🤞 Automation Panel</h1>

            <p>Powerful yamdhud automation tools for Facebook Messenger</p>
        ...
        <div class="content">
            ...
            <div class="feature-panel" id="messageSenderPanel">
                ...
                <button class="back-btn" onclick="showFeatureSelection()">← Back</button>
